...
def _test():
    df = pd.read_csv('pottery_sample.csv', index_col='Level', usecols=lambda x: x != 'Unnamed: 0') # Cambia 'ruta_de_tu_archivo.csv' con la ruta correcta de tu archivo CSV.
    ...
    # Ajusta el tamaño de letra en el gráfico
    plt.title('Tu Título', fontsize=14)
    plt.xlabel('Eje X', fontsize=9)
    plt.ylabel('Eje Y', fontsize=9)
    plt.xticks(fontsize=9)
    plt.yticks(fontsize=9)
    plt.savefig('ca_plot.png', format='png', dpi=300, bbox_inches='tight')
